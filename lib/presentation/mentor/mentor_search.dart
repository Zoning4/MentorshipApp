...
class MentorSearch extends StatefulWidget {
  ...
  @override
  State<MentorSearch> createState() => _MentorSearchState();
}
...
class _MentorSearchState extends State<MentorSearch> {
  ...
  final List<Map<String, String>> _mentees = [
    {'name': 'Nguemo Alain',    'dept': 'B.Tech', 'level': '1', 'email': 'n.alain@iuc.edu.cm',    'status': 'Online'},
    {'name': 'Simo Carole',     'dept': 'B.Tech', 'level': '1', 'email': 's.carole@iuc.edu.cm',    'status': 'Offline'},
    {'name': 'Djiofack Paul',   'dept': 'B.Eng',  'level': '1', 'email': 'd.paul@iuc.edu.cm',      'status': 'Online'},
    {'name': 'Ateba Claire',    'dept': 'B.Eng',  'level': '1', 'email': 'a.claire@iuc.edu.cm',    'status': 'Offline'},
    {'name': 'Mbassi Joseph',   'dept': 'B.Sc',   'level': '1', 'email': 'm.joseph@iuc.edu.cm',    'status': 'Online'},
    {'name': 'Ndom Sylvie',     'dept': 'B.Sc',   'level': '1', 'email': 'n.sylvie@iuc.edu.cm',    'status': 'Online'},
  ];

  List<Map<String, String>> get _filtered => _mentees.where((m) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Find Your Mentee',
        ...
        Expanded(
          child: _filtered.isEmpty
              ? const Center(child: Column(
                  ...
                  SizedBox(height: 12),
                  Text('No mentees found',
                      style: TextStyle(color: Colors.grey)),
                ]))
              : ListView.builder(
                  padding: const EdgeInsets.all(16),
                  itemCount: _filtered.length,
                  itemBuilder: (ctx, i) => _menteeCard(_filtered[i])),
        ),
      ]),
    );
  }
  ...
  Widget _menteeCard(Map<String, String> m) {
        ...
        child: Row(children: [
          Stack(children: [
            CircleAvatar(
              ...
              child: Text(m['name']![0],
                  style: const TextStyle(color: AppColors.menteeColor,
          ...
          Expanded(child: Column(
            ...
            Text('${m['dept']} · Level ${m['level']} Mentee',
                style: const TextStyle(color: AppColors.menteeColor,
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Icon(Icons.chat_bubble_outline,
                  color: AppColors.mentorColor, size: 20),
            ),
          ),
        ]),
      ),
