...
f,b.memoizedState=f,b.flags&256){e=lj(Error(p(423)),b);b=Rj(a,b,d,c,e);break a}else if(d!==e){e=lj(Error(p(424)),b);b=Rj(a,b,d,c,e);break a}else for(Mg=Zf(b.stateNode.containerInfo.firstChild),Lg=b,J=!0,Ng=null,c=ih(b,null,d,c),b.child=c;c;)c.flags=c.flags&-3|4096,c=c.sibling;else{Wg();if(d===e){b=Cj(a,b,c);break a}Aj(a,b,d,c)}b=b.